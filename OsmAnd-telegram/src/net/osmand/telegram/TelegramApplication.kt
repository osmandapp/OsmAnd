...
class TelegramApplication : Application(), OsmandHelperListener {
	...
	lateinit var localDataHelper: TelegramLocalDataHelper private set
	...
	override fun onCreate() {
		...
		localDataHelper = TelegramLocalDataHelper(this)

		if (localDataHelper.hasAnyChatToShareLocation() && AndroidUtils.isLocationPermissionAvailable(this)) {
