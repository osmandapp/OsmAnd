...
class QuadRect {
	...
	// Copy constructor
	constructor(a: QuadRect) : this(a.left, a.top, a.right, a.bottom)
	...
	fun contains(box: QuadRect): Boolean {
		return contains(box.left, box.top, box.right, box.bottom)
	}

	companion object {
		fun intersects(a: QuadRect, b: QuadRect): Boolean {
		...
		fun intersectionArea(a: QuadRect, b: QuadRect): Double {
		...
		fun trivialOverlap(a: QuadRect, b: QuadRect): Boolean {
