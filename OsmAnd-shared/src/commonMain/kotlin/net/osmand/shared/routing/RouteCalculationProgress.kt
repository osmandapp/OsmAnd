 ...
 * took.
 *
 * Both routers write here - the Java planner directly, and the C++ core through JNI, which reads
 * and writes about thirty of these fields by name, including the private ones. Renaming any of them
 * breaks the native build silently, so keep the names in step with `java_wrap.cpp`.
 */
