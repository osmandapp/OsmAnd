...
import net.osmand.activities.DayNightHelper;
import net.osmand.activities.LiveMonitoringHelper;
import net.osmand.activities.OsmandIntents;
...
import net.osmand.api.SQLiteAPIImpl;
import net.osmand.api.SettingsAPI;
import net.osmand.data.FavouritePoint;
import net.osmand.plus.R;
import net.osmand.render.NativeOsmandLibrary;
import net.osmand.render.RendererRegistry;
import net.osmand.render.RenderingRulesStorage;
import net.osmand.resources.ResourceManager;
import net.osmand.routing.RoutingHelper;
import net.osmand.util.Algorithms;
import net.osmand.utils.PlatformUtil;
import net.osmand.voice.CommandPlayer;
import net.osmand.voice.CommandPlayerException;
import net.osmand.voice.CommandPlayerFactory;
...
public class OsmandApplication extends Application implements ClientContext {
	...
	public void onCreate() {
		...
		settingsAPI = new net.osmand.api.SettingsAPIImpl(this);
		externalServiceAPI = new net.osmand.api.ExternalServiceAPIImpl(this);
		internalToDoAPI = new net.osmand.api.InternalToDoAPIImpl(this);
		internalOsmAndAPI = new net.osmand.api.InternalOsmAndAPIImpl(this);
