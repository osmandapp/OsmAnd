...
import net.osmand.activities.FavouritesListActivity;
import net.osmand.activities.FavouritesListFragment;
import net.osmand.activities.NavigatePointFragment;
