...
import net.osmand.OsmAndLocationProvider.OsmAndCompassListener;
import net.osmand.OsmAndLocationProvider.OsmAndLocationListener;
import net.osmand.access.AccessibleToast;
import net.osmand.access.NavigationInfo;
import net.osmand.activities.EditPOIFilterActivity;
import net.osmand.activities.MapActivity;
import net.osmand.activities.MapActivityActions;
import net.osmand.activities.OsmandListActivity;
import net.osmand.data.Amenity;
import net.osmand.data.AmenityType;
import net.osmand.data.LatLon;
import net.osmand.osm.MapRenderingTypes;
import net.osmand.plus.R;
import net.osmand.render.RenderingIcons;
