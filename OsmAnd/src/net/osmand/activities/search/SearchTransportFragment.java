...
import net.osmand.activities.search.SearchActivity.SearchActivityChild;
import net.osmand.data.LatLon;
import net.osmand.data.TransportRoute;
import net.osmand.data.TransportStop;
import net.osmand.plus.R;
import net.osmand.resources.TransportIndexRepository;
import net.osmand.resources.TransportIndexRepository.RouteInfoLocation;
