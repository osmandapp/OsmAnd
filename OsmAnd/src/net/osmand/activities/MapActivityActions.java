...
import net.osmand.OsmAndLocationProvider;
...
import net.osmand.activities.actions.OsmAndDialogs;
import net.osmand.activities.actions.ShareLocation;
import net.osmand.activities.actions.StartGPSStatus;
import net.osmand.activities.actions.NavigateAction.DirectionDialogStyle;
...
import net.osmand.views.BaseMapLayer;
import net.osmand.views.MapTileLayer;
