...
import net.osmand.base.BasicProgressAsyncTask;
import net.osmand.base.SuggestExternalDirectoryDialog;
import net.osmand.download.DownloadActivityType;
import net.osmand.download.DownloadEntry;
import net.osmand.download.DownloadIndexAdapter;
import net.osmand.download.DownloadIndexesThread;
import net.osmand.download.IndexItem;
import net.osmand.download.IndexItemCategory;
