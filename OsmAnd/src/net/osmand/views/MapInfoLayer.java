...
import net.osmand.views.mapwidgets.AppearanceWidgetsFactory;
import net.osmand.views.mapwidgets.BaseMapWidget;
import net.osmand.views.mapwidgets.ImageViewWidget;
import net.osmand.views.mapwidgets.MapInfoWidgetsFactory;
import net.osmand.views.mapwidgets.MapWidgetRegistry;
import net.osmand.views.mapwidgets.NextTurnInfoWidget;
import net.osmand.views.mapwidgets.RouteInfoWidgetsFactory;
import net.osmand.views.mapwidgets.StackWidgetView;
import net.osmand.views.mapwidgets.TextInfoWidget;
import net.osmand.views.mapwidgets.UpdateableWidget;
import net.osmand.views.mapwidgets.MapInfoWidgetsFactory.TopTextView;
import net.osmand.views.mapwidgets.MapWidgetRegistry.MapWidgetRegInfo;
