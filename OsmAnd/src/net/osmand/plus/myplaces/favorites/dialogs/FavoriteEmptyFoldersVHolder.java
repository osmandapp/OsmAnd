...
public class FavoriteEmptyFoldersVHolder extends RecyclerView.ViewHolder {
	...
	public FavoriteEmptyFoldersVHolder(@NonNull View view, @Nullable FavoriteAdapterListener listener) {
		super(view);
	...
	public void bindView() {
		title.setText(R.string.empty_state_favourites);
		description.setText(R.string.empty_state_favourites_desc);
