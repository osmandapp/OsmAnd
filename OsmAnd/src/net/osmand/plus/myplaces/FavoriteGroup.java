...
public class FavoriteGroup {
	...
	public static boolean isPersonalCategoryDisplayName(@NonNull Context ctx, String name) {
		return name.equals(ctx.getString(R.string.personal_category_name));
	}

	public static String convertDisplayNameToGroupIdName(@NonNull Context context, String name) {
	...
	public PointsGroup toPointsGroup(@NonNull Context ctx) {
		...
		pointsGroup.setName(getName());
		pointsGroup.setColor(getColor());
		pointsGroup.setIconName(getIconName());
		pointsGroup.setBackgroundType(getBackgroundType().getTypeName());
