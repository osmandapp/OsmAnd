...
import net.osmand.plus.plugins.aistracker.AisObjectAndroidHelperKt;
...
public class AisSimulationProvider {
	...
	public void testCrossingTimes() {
		...
		a1.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(1.0f));
		a1.setBearing(90.0f);
		a2.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(1.0f));
		a2.setBearing(90.0f);
		a3.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(1.0f));
		a3.setBearing(90.0f);
		a4.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(1.0f));
		a4.setBearing(90.0f);
		a5.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(1.0f));
		a5.setBearing(90.0f);
		a6.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(1.0f));
		a6.setBearing(90.0f);
		b1.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(1.0f));
		b1.setBearing(45.0f);
		b2.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(1.0f));
		b2.setBearing(45.0f);
		b3.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(1.0f));
		b3.setBearing(45.0f);
		b4.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(1.0f));
		b4.setBearing(45.0f);
		b5.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(1.0f));
		b5.setBearing(45.0f);
		b6.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(1.0f));
		b6.setBearing(45.0f);
		// now trigger the calculations:
		cpa.reset();
		getCpa(a3, b2, cpa); // expected: t1>0, t2>0
		Log.d("AisTrackerLayer", "# test(a3, b2): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
		cpa.reset();
		getCpa(a3, b3, cpa); // expected: t1>0, t2>0
		Log.d("AisTrackerLayer", "# test(a3, b3): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
		cpa.reset();
		getCpa(a3, b4, cpa); // expected: t1>0, t2->0
		Log.d("AisTrackerLayer", "# test(a3, b4): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
		cpa.reset();
		getCpa(a3, b5, cpa); // expected: t1>0, t2<0
		Log.d("AisTrackerLayer", "# test(a3, b5): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
		cpa.reset();
		getCpa(a3, b6, cpa); // expected: t1>0, t2<0
		Log.d("AisTrackerLayer", "# test(a3, b6): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
		cpa.reset();
		getCpa(a4, b2, cpa); // expected: t1->0, t2>0
		Log.d("AisTrackerLayer", "# test(a4, b2): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
		cpa.reset();
		getCpa(a4, b3, cpa); // expected: t1->0, t2>0
		Log.d("AisTrackerLayer", "# test(a4, b3): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
		cpa.reset();
		getCpa(a4, b4, cpa); // expected: t1->0, t2->0
		Log.d("AisTrackerLayer", "# test(a4, b4): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
		cpa.reset();
		getCpa(a4, b5, cpa); // expected: t1->0, t2<0
		Log.d("AisTrackerLayer", "# test(a4, b5): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
		cpa.reset();
		getCpa(a4, b6, cpa); // expected: t1->0, t2<0
		Log.d("AisTrackerLayer", "# test(a4, b6): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
		cpa.reset();
		getCpa(a5, b2, cpa); // expected: t1<0, t2>0
		Log.d("AisTrackerLayer", "# test(a5, b2): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
		cpa.reset();
		getCpa(a5, b3, cpa); // expected: t1<0, t2>0
		Log.d("AisTrackerLayer", "# test(a5, b3): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
		cpa.reset();
		getCpa(a5, b4, cpa); // expected: t1<0, t2->0
		Log.d("AisTrackerLayer", "# test(a5, b4): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
		cpa.reset();
		getCpa(a5, b5, cpa); // expected: t1<0, t2<0
		Log.d("AisTrackerLayer", "# test(a5, b5): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
		cpa.reset();
		getCpa(a5, b6, cpa); // expected: t1<0, t2<0
		Log.d("AisTrackerLayer", "# test(a5, b6): t1->" + cpa.getT1() +
				", t2->" + cpa.getT2() + ", CPA-Dist-> " + cpa.getCpa() +
				", TCPA ->" + cpa.getTcpa());
	...
	public void testCpa() {
		...
		x1.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(5.0f));
		x1.setBearing(0.0f);
		x3.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(10.0f));
		x3.setBearing(270.0f);
		AisCpa cpa1 = new AisCpa();
		getCpa(x1, x3, cpa1);
		Log.d("AisTrackerLayer", "# test1: tcpa(x1, x3): " + cpa1.getTcpa());
		Log.d("AisTrackerLayer", "# test1: dist at tcpa: " + cpa1.getCpa());
		Log.d("AisTrackerLayer", "# test1: dist0: " + AisTrackerMath.INSTANCE.meterToMiles(x1.distanceTo(x3)));
		y1 = getNewPositionLocal(x1, 1.0);
		y3 = getNewPositionLocal(x3, 1.0);
		if ((y1 != null) && (y3 != null)) {
			...
			Log.d("AisTrackerLayer", "# test1: dist1: " + AisTrackerMath.INSTANCE.meterToMiles(y1.distanceTo(y3)));
		}
		y1 = getNewPositionLocal(x1, 1.18);
		y3 = getNewPositionLocal(x3, 1.18);
		if ((y1 != null) && (y3 != null)) {
		...
		y1 = getNewPositionLocal(x1, 1.5);
		y3 = getNewPositionLocal(x3, 1.5);
		if ((y1 != null) && (y3 != null)) {
		...
		x1.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(5.0f));
		x1.setBearing(0.0f);
		x3.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(5.0f));
		x3.setBearing(270.0f);
		cpa1.reset();
		getCpa(x1, x3, cpa1);
		Log.d("AisTrackerLayer", "# test2: tcpa(x1, x3): " + cpa1.getTcpa());
		Log.d("AisTrackerLayer", "# test2: dist at tcpa: " + cpa1.getCpa());
		Log.d("AisTrackerLayer", "# test2: dist0: " + AisTrackerMath.INSTANCE.meterToMiles(x1.distanceTo(x3)));
		y1 = getNewPositionLocal(x1, 1.0);
		y3 = getNewPositionLocal(x3, 1.0);
		if ((y1 != null) && (y3 != null)) {
			...
			Log.d("AisTrackerLayer", "# test2: position 3 after 1 hour: "
					+ LocationConvert.convertLatitude(y3.getLatitude(), FORMAT_MINUTES, true)
					+ ", " + LocationConvert.convertLongitude(y3.getLongitude(), FORMAT_MINUTES, true));
			Log.d("AisTrackerLayer", "# test2: dist1: " + AisTrackerMath.INSTANCE.meterToMiles(y1.distanceTo(y3)));
		}
		y1 = getNewPositionLocal(x1, 1.5);
		y3 = getNewPositionLocal(x3, 1.5);
		if ((y1 != null) && (y3 != null)) {
		...
		y1 = getNewPositionLocal(x1, 2.0);
		y3 = getNewPositionLocal(x3, 2.0);
		if ((y1 != null) && (y3 != null)) {
		...
		x2.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(5.0f));
		...
		Log.d("AisTrackerLayer", "# test3: dist at tcpa: " + cpa1.getCpa());
		Log.d("AisTrackerLayer", "# test3: dist0: " + AisTrackerMath.INSTANCE.meterToMiles(x2.distanceTo(x3)));
		y2 = getNewPositionLocal(x2, 5.0);
		y3 = getNewPositionLocal(x3, 5.0);
		if ((y2 != null) && (y3 != null)) {
			...
			Log.d("AisTrackerLayer", "# test3: position 3 after 5 hours: "
					+ LocationConvert.convertLatitude(y3.getLatitude(), FORMAT_MINUTES, true)
					+ ", " + LocationConvert.convertLongitude(y3.getLongitude(), FORMAT_MINUTES, true));
			Log.d("AisTrackerLayer", "# test3: dist1: " + AisTrackerMath.INSTANCE.meterToMiles(y2.distanceTo(y3)));
		}
		...
		x4.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(10.0f));
		x4.setBearing(45.0f);
		x5.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(5.0f));
		x5.setBearing(70.0f);
		cpa1.reset();
		getCpa(x4, x5, cpa1);
		Log.d("AisTrackerLayer", "# test4: tcpa(x4, x5): " + cpa1.getTcpa());
		Log.d("AisTrackerLayer", "# test4: dist at tcpa: " + cpa1.getCpa());
		Log.d("AisTrackerLayer", "# test4: dist0: " + AisTrackerMath.INSTANCE.meterToMiles(x4.distanceTo(x5)));
		y4 = getNewPositionLocal(x4, 6.0);
		y5 = getNewPositionLocal(x5, 6.0);
		if ((y4 != null) && (y5 != null)) {
			...
			Log.d("AisTrackerLayer", "# test4: dist1: " + AisTrackerMath.INSTANCE.meterToMiles(y4.distanceTo(y5)));
		}
	}
	...
	public void initFakePosition() {
		...
		fake.setSpeed(AisTrackerMath.INSTANCE.knotsToMeterPerSecond(fakeSOG));
    ...
    private static void getCpa(Location x, Location y, AisCpa cpa) {
        if (x != null && y != null && cpa != null) {
            AisTrackerMath.INSTANCE.getCpa(AisObjectAndroidHelperKt.toAisLocation(x), AisObjectAndroidHelperKt.toAisLocation(y), cpa);
        }
    }

    private static Location getNewPositionLocal(Location loc, double timeInHours) {
        if (loc != null) {
            net.osmand.shared.aistracker.AisLatLon newAisLatLon = AisTrackerMath.INSTANCE.getNewPosition(AisObjectAndroidHelperKt.toAisLocation(loc), timeInHours);
            if (newAisLatLon != null) {
                Location newLocation = new Location(loc);
                newLocation.setLatitude(newAisLatLon.getLatitude());
                newLocation.setLongitude(newAisLatLon.getLongitude());
                return newLocation;
            }
        }
        return null;
