...
public class EditDeviceNameDialog extends BaseOsmAndDialogFragment {
	...
	private static final String ADDRESS_KEY = "content_key";
	...
	public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		if (args != null) {
			...
			deviceAddress = args.getString(ADDRESS_KEY);
		}
	...
	private void onSaveEditedText(@NonNull String newName) {
		...
		if (target instanceof OnSaveDeviceNameCallback) {
			OnSaveDeviceNameCallback callback = (OnSaveDeviceNameCallback) target;
			callback.changeDeviceName(newName, deviceAddress);
		}
	}

	public static void showInstance(@NonNull FragmentActivity activity, @NonNull String name, @Nullable Fragment target, @NonNull String address) {
	...
	public interface OnSaveDeviceNameCallback {
		void changeDeviceName(@NonNull String newName, @NonNull String deviceAddress);
	}
}
