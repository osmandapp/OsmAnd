...
public abstract class AntPlusBaseFragment extends BaseOsmAndDialogFragment {

	public static final String TAG = AntPlusBaseFragment.class.getSimpleName();
	protected AntPlusPlugin plugin;
	...
	public void onCreate(@Nullable Bundle savedInstanceState) {
		...
		plugin = PluginsHelper.getPlugin(AntPlusPlugin.class);
	}
