...
public class TripRecordingDistanceWidgetState extends WidgetState {
	...
	public enum TripRecordingDistanceMode {
		...
		LAST_DOWNHILL(R.string.shared_string_last_downhill, R.drawable.widget_trip_recording_distance_last_downhill_day, R.drawable.widget_trip_recording_distance_downhill_night),
		LAST_UPHILL(R.string.shared_string_last_uphill, R.drawable.widget_trip_recording_distance_last_uphill_day, R.drawable.widget_trip_recording_distance_uphill_night);
