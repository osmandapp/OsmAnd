...
import net.osmand.plus.plugins.odb.adapters.FoundDevicesAdapter
import net.osmand.plus.plugins.odb.adapters.FoundDevicesAdapter.DeviceClickListener
...
class OBDDevicesSearchFragment : OBDDevicesBaseFragment(), VehicleMetricsPlugin.ScanDevicesListener,
    ...
    override val layoutId: Int
        get() = R.layout.fragment_ant_plus_search
