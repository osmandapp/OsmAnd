...
public class OsmandDevelopmentPlugin extends OsmandPlugin {
	...
	public final OsmandPreference<Boolean> SHOW_ROUTE_ALERTS_DEBUG_DIALOG;
	...
	public OsmandDevelopmentPlugin(@NonNull OsmandApplication app) {
		...
		SHOW_ROUTE_ALERTS_DEBUG_DIALOG = registerBooleanPreference("show_route_alerts_debug_dialog", false).makeGlobal().makeShared().cache();
