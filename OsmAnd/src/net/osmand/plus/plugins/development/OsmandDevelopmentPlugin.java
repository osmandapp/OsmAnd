...
public class OsmandDevelopmentPlugin extends OsmandPlugin {
	...
	public final OsmandPreference<Boolean> SHOW_TILES_PRIMITIVISATION_DEBUG_INFO;
	...
	public OsmandDevelopmentPlugin(@NonNull OsmandApplication app) {
		...
		SHOW_TILES_PRIMITIVISATION_DEBUG_INFO = registerBooleanPreference("show_tiles_primitivisation_debug_info", false).makeGlobal().makeShared().cache();
		...
		SHOW_TILES_PRIMITIVISATION_DEBUG_INFO.addListener(symbolsDebugInfoListener);
