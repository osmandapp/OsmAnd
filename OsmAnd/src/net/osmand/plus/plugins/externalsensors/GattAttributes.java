...
public class GattAttributes {
	...
	static {
		...
		SUPPORTED_CHARACTERISTICS.add(UUID.fromString(CHARACTERISTIC_CYCLING_POWER_MEASUREMENT));
		...
		SUPPORTED_CHARACTERISTICS.add(UUID.fromString(SERVICE_CYCLING_POWER));
