...
public class NewAdvancedEditPoiFragment extends BaseOsmAndFragment implements EditPoiDialogFragment.OnFragmentActivatedListener,
	...
	public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		EditPoiContentAdapter.EditPoiListener editPoiListener = new EditPoiContentAdapter.EditPoiListener() {
			...
			public FragmentManager getChildFragmentManager() {
				return NewAdvancedEditPoiFragment.this.getChildFragmentManager();
			}
		};
