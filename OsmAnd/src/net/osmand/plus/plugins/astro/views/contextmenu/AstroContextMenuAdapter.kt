...
import net.osmand.plus.plugins.astro.views.contextmenu.AstroContextCard
import net.osmand.plus.plugins.astro.SkyObject
import net.osmand.plus.plugins.astro.views.contextmenu.AstroCatalogsCardModel
import net.osmand.plus.plugins.astro.views.contextmenu.AstroCatalogsCardViewHolder
import net.osmand.plus.plugins.astro.views.contextmenu.AstroDescriptionCardModel
import net.osmand.plus.plugins.astro.views.contextmenu.AstroDescriptionCardViewHolder
import net.osmand.plus.plugins.astro.views.contextmenu.AstroGalleryCardModel
import net.osmand.plus.plugins.astro.views.AstroGalleryCardViewHolder
import net.osmand.plus.plugins.astro.views.AstroScheduleCardModel
import net.osmand.plus.plugins.astro.views.AstroScheduleCardViewHolder
import net.osmand.plus.plugins.astro.views.AstroVisibilityCardModel
import net.osmand.plus.plugins.astro.views.AstroVisibilityCardViewHolder
