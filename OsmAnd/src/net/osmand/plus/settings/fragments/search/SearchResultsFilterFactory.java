...
class SearchResultsFilterFactory {
	...
	public static SearchResultsFilter createSearchResultsFilter(final Collection<String> allProfiles,
																final OsmandPreference<String> enabledProfiles) {
		return new SearchResultsFilter(isDisabledProfile(allProfiles, enabledProfiles));
	}
