...
class IncludePreferenceInSearchResultsPredicate {
	...
	private static boolean isPreferenceConnectedToAnyInactivePlugin(final SearchablePreferenceOfHostWithinGraph preference) {
	...
	private static boolean isPreferenceConnectedToPlugin(final SearchablePreferenceOfHostWithinGraph preference,
	...
	private static boolean isPreferenceOnSettingsScreen(final SearchablePreferenceOfHostWithinGraph preference,
