...
import net.osmand.plus.plugins.aprs.AprsSettingsFragment;
...
public enum SettingsScreenType {
	...
	APRS_SETTINGS(AprsSettingsFragment.class.getName(), true, ApplyQueryType.SNACK_BAR, R.xml.aprs_settings, R.layout.profile_preference_toolbar),
