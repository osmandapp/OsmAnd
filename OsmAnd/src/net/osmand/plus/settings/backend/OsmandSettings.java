...
//	}
	...
	public final CommonPreference<Integer> LOCATION_INTERPOLATION_PERCENT = new IntPreference(this, "location_interpolation_percent", 0) {

		@Override
		public Integer get() {
			return ANIMATE_MY_LOCATION.get() ? super.get() : 0;
		}
