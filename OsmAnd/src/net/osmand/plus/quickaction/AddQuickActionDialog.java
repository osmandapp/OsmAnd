...
public class AddQuickActionDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        List<QuickAction> active = mapActivity
                .getMapLayers()
                .getQuickActionRegistry()
                .getQuickActions();

        View root = inflater.inflate(R.layout.quick_action_add_dialog, container, false);
        Adapter adapter = new Adapter(QuickActionFactory.produceTypeActionsListWithHeaders(active, mapActivity.getMyApplication()));
