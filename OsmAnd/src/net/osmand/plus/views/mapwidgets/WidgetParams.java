...
public enum WidgetParams {
	...
	TRUE_BEARING("true_bearing", R.string.map_widget_true_bearing, 0, R.drawable.widget_bearing_day, R.drawable.widget_bearing_night, 0, WidgetGroup.BEARING, RIGHT),
