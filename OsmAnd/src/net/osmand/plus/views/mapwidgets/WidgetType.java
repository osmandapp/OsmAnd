...
public enum WidgetType {
	...
	TRIP_RECORDING_AVG_SPEED("trip_recording_avg_speed", R.string.map_widget_average_speed, R.string.trip_recording_avg_speed_widget_description, R.drawable.widget_track_recording_max_speed_day, R.drawable.widget_track_recording_max_speed_night, 0, WidgetGroup.TRIP_RECORDING, RIGHT), // TODO: change icons
	TRIP_RECORDING_MOVING_TIME("trip_recording_moving_time", R.string.trip_recording_moving_time, R.string.trip_recording_moving_time_widget_description, R.drawable.widget_track_recording_average_speed_day, R.drawable.widget_track_recording_average_speed_night, 0, TRIP_RECORDING, RIGHT),
