...
public class AidlTileProvider extends interface_MapTiledCollectionProvider {
	...
	public AidlTileProvider(AidlMapLayer aidlMapLayer, float density, float y_offset) {
		...
		this.pointsType = aidlMapLayer.pointsType;
		this.bitmapPaint = aidlMapLayer.bitmapPaint;
		this.pointInnerCircle = aidlMapLayer.pointInnerCircle;
		this.pointOuterCircle = aidlMapLayer.pointOuterCircle;
		this.radius = aidlMapLayer.radius;
		this.circle = aidlMapLayer.circle;
		this.smallIconSize = aidlMapLayer.smallIconSize;
		this.bigIconSize = aidlMapLayer.bigIconSize;
		this.bigIconBg = aidlMapLayer.bigIconBg;
		this.bigIconBgStale = aidlMapLayer.bigIconBgStale;
		this.smallIconBg = aidlMapLayer.smallIconBg;
