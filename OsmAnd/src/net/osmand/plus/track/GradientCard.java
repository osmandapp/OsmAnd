...
public class GradientCard extends MapBaseCard {
	...
	protected void updateContent() {
		...
		boolean hasSpeedHeightData = gpxTrackAnalysis != null;
		boolean isRouteAltitude = !hasSpeedHeightData && selectedScaleType == GradientScaleType.ALTITUDE;
		AndroidUiHelper.updateVisibility(view, true);
		AndroidUiHelper.updateVisibility(view.findViewById(R.id.upper_space), hasSpeedHeightData || isRouteAltitude);
		AndroidUiHelper.updateVisibility(view.findViewById(R.id.bottom_space), hasSpeedHeightData);
