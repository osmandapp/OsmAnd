...
public class SingleSelectionDialogFragment extends DialogFragment implements SettingHighlighterProvider {
	...
	public static class PreferenceFragment extends PreferenceFragmentCompat implements InitializePreferenceFragmentWithFragmentBeforeOnCreate<SingleSelectionDialogFragment> {
		...
		public void onCreatePreferences(@Nullable final Bundle savedInstanceState, @Nullable final String rootKey) {
			setPreferenceScreen(asPreferenceScreen(asPreferences(singleSelectionDialogFragment.getItemByKey())));
		}
