...
public class EditProfileFragment extends BaseOsmAndFragment {
	...
	public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
		...
		} else if (isNew && profile.parent != null) {
		...
		profileNameEt.setCursorVisible(false);
		profileNameEt.setTextIsSelectable(false);
		...
		saveButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (ApplicationMode.allPossibleValues().contains(profile)) {
					...
					saveNewProfile(profile, selectedRoutingProfile);
				}
			}
		});
	...
	private boolean saveNewProfile(
		TempApplicationProfile profile,
