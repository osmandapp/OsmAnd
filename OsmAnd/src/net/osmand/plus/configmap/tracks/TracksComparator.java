	...
	private int compareTrackItems(@NonNull TrackItem item1, @NonNull TrackItem item2) {
		...
		switch (sortMode) {
			...
			case DATE_ASCENDING:
				...
				long time1_asc = dataItem1 == null ? startTime1_asc : dataItem1.getGpxData().getValue(GPX_COL_FILE_CREATION_TIME);
				long time2_asc = dataItem2 == null ? startTime2_asc : dataItem2.getGpxData().getValue(GPX_COL_FILE_CREATION_TIME);
			...
			case DATE_DESCENDING:
				...
				long time1_desc = dataItem1 == null ? startTime1_desc : dataItem1.getGpxData().getValue(GPX_COL_FILE_CREATION_TIME);
				long time2_desc = dataItem2 == null ? startTime2_desc : dataItem2.getGpxData().getValue(GPX_COL_FILE_CREATION_TIME);
