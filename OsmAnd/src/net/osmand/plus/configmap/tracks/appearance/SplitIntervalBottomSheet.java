...
public class SplitIntervalBottomSheet extends MenuBottomSheetDialogFragment {
	...
	public static final String TAG = net.osmand.plus.track.fragments.SplitIntervalBottomSheet.class.getSimpleName();

	private static final Log log = PlatformUtil.getLog(net.osmand.plus.track.fragments.SplitIntervalBottomSheet.class);
	...
	public static void showInstance(@NonNull FragmentActivity activity) {
		try {
			...
			if (fragmentManager.findFragmentByTag(TAG) == null) {
				new SplitIntervalBottomSheet().show(fragmentManager, TAG);
			}
