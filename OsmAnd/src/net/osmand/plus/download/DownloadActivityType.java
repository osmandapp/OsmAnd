...
public class DownloadActivityType {
	...
	public String getVisibleName(DownloadItem downloadItem, Context ctx, OsmandRegions osmandRegions, boolean includeParent, String format) {
		if (this == VOICE_FILE) {
...
//		}
		...
		if (basename.contains("addresses-nationwide")) {
			...
			return osmandRegions.getLocaleName(downloadName, includeParent, format) +
		...
		return osmandRegions.getLocaleName(basename, includeParent, format);
	}
