...
public class DownloadActivityType {
	...
	public String getVisibleName(DownloadItem downloadItem, Context ctx, OsmandRegions osmandRegions, String format) {
		if (this == VOICE_FILE) {
...
//		}
		...
		if (basename.contains("addresses-nationwide")) {
			...
			return osmandRegions.getLocaleName(downloadName, format) +
		...
		return osmandRegions.getLocaleName(basename, format);
	}
