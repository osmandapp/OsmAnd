...
public class SelectedGpxMenuBuilder extends MenuBuilder {
	...
	public void buildOverviewRows(View view) {
		...
		String timeSpan = Algorithms.formatDuration((int) (analysis.getTimeSpan() / 1000), app.accessibilityEnabled());
	...
	public void buildCustomAddressLine(LinearLayout ll) {
		...
		buildTextView(ll, gpxSmallTextMargin, gpxTextSize, textColor,
				Algorithms.formatDuration((int) (analysis.getTimeSpan() / 1000), app.accessibilityEnabled()) + "");
	}
