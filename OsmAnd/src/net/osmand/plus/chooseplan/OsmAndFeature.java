...
public enum OsmAndFeature {
	...
	TERRAIN(R.string.srtm_plugin_nam, R.string.contour_lines_hillshade_slope, R.string.purchases_feature_desc_terrain, R.drawable.ic_action_srtm_colored_day, R.drawable.ic_action_srtm_colored_day),
