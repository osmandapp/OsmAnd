...
public class TripltekPromoFragment extends BaseOsmAndDialogFragment {

	public static final String TAG = TripltekPromoFragment.class.getSimpleName();

	private static final List<OsmAndFeature> TRIPLTEK_FEATURES = Arrays.asList(
	...
	public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		View view = themedInflater.inflate(R.layout.fragment_tripltek_promo, container, false);
	...
	private void setupContent(@NonNull View view) {
		...
		for (OsmAndFeature feature : TRIPLTEK_FEATURES) {
