...
import net.osmand.OsmAndTaskManager.OsmAndTaskRunnable;
...
import net.osmand.views.MonitoringInfoControl;
import net.osmand.views.OsmandMapTileView;
import net.osmand.views.MonitoringInfoControl.MonitoringInfoControlServices;
import net.osmand.views.MonitoringInfoControl.ValueHolder;
import net.osmand.views.OsmandMapLayer.DrawSettings;
