...
import net.osmand.audionotes.AudioVideoNotesPlugin;
import net.osmand.development.OsmandDevelopmentPlugin;
import net.osmand.distancecalculator.DistanceCalculatorPlugin;
import net.osmand.monitoring.OsmandMonitoringPlugin;
import net.osmand.osmedit.OsmEditingPlugin;
import net.osmand.osmodroid.OsMoDroidPlugin;
import net.osmand.parkingpoint.ParkingPositionPlugin;
import net.osmand.rastermaps.OsmandRasterMapsPlugin;
