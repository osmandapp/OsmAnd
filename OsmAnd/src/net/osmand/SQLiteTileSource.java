...
import net.osmand.api.SQLiteAPI.SQLiteConnection;
import net.osmand.api.SQLiteAPI.SQLiteCursor;
...
public class SQLiteTileSource implements ITileSource {
	...
	public synchronized void insertImage(int x, int y, int zoom, File fileToSave) throws IOException {
		...
		net.osmand.api.SQLiteAPI.SQLiteStatement statement = db.compileStatement(query); //$NON-NLS-1$
