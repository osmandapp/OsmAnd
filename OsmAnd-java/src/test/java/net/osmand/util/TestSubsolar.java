...
public class TestSubsolar {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		int tests = 0, fail = 0;
		double lon = 0;
		for (double lat = -75; lat <= 75; lat += 5) {
//		double lat = 20; {
			for (int h = 0; h < 24; h++) {
//			int h = 18; {
				String utcTimeString = String.format("2025-05-10T%02d:00:00Z", h);
