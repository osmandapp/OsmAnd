...
public class MissingMapsCalculationResult {
	...
	private boolean onlineResultPoints = false;
	...
	public boolean isOnlineResultPoints() {
		return onlineResultPoints;
	}
}
