...
public class RouteColorize {
    ...
    public static final double[][] SLOPE_PALETTE = {{SLOPE_MIN_VALUE, BLUE_SLOPE}, {-0.20, CYAN_SLOPE}, {-0.10, GREEN_SLOPE}, {0.0, WHITE}, {0.10, YELLOW_SLOPE}, {0.20, RED_SLOPE}, {SLOPE_MAX_VALUE, PURPLE_SLOPE}};
