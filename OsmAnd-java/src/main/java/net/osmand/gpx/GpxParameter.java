...
public enum GpxParameter {
	...
	TRACK_VISUALIZATION_TYPE("track_visualization_type", "TEXT", String.class, null, false),
	TRACK_3D_WALL_COLORING_TYPE("track_3d_wall_coloring_type", "TEXT", String.class, null, false),
	TRACK_3D_LINE_POSITION_TYPE("track_3d_line_position_type", "TEXT", String.class, null, false),
