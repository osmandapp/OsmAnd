...
public enum GpxParameter {
	...
	WPT_CATEGORY_NAMES("wptCategoryNames", "TEXT", String.class, null, false),
	...
	START_LAT("startLat", "double", String.class, null, true),
	START_LON("startLon", "double", String.class, null, true),
