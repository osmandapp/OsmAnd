...
public class SearchUICore {
	...
	public void init() {
		...
		SearchCoreFactory.SearchPoiTopIndexAdditionalAPI searchPoiTopIndexAdditionalAPI = new SearchCoreFactory.SearchPoiTopIndexAdditionalAPI();
		apis.add(searchPoiTopIndexAdditionalAPI);
